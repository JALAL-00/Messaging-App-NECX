            ...
            <div className="max-w-4xl mx-auto">
                <form onSubmit={handleSubmit} className="flex items-center space-x-4">
                    <input 
                        ...
                        className="flex-1 bg-primary border border-border rounded-lg px-4 py-3 text-base placeholder-text-secondary focus:outline-none focus:ring-2 focus:ring-accent-green w-full"
                    />
                    <button
                        type="submit"
